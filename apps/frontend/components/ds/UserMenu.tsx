  ...
  return (
    <div ref={ref} style={{ position: 'relative' }}>
      <button
        ...
        aria-label={user?.email ? `Menú de usuario, ${user.email}` : 'Menú de usuario'}
        aria-expanded={open}
      >
      ...
      {open && (
        <div role="menu" aria-label="Menú de usuario" style={{
          ...
          <div style={{ padding: '6px 0' }}>
            {/* El <Link> es el ítem: un <button> dentro de un <a> es HTML inválido. */}
            <Link
              href="/settings"
              role="menuitem"
          ...
          <div style={{ borderTop: '1px solid var(--border-1)', padding: '6px 0' }}>
            <button role="menuitem" onClick={() => { setOpen(false); logout() }} style={{ ...itemStyle, color: 'var(--down)' }}>
              <svg aria-hidden width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
